...
(2,'Marvels Spider-Man','187620','Videojuego de acción y aventuras desarrollado por Insomniac Games','13000',12,4),
(3,'Halo Infinite','541984','Videojuego de disparos en primera persona desarrollado por 343 Industries','20000',13,4),
(4,'Dishonored','102516','Videojuego de acción-aventura y sigilo en primera persona desarrollado por Arkane Studios','10000',14,4),
...
(8,'Skyrim','812394','Videojuego de acción y aventuras desarrollado por Bethesda','14000',14,4),
(9,'DOOM Eternal','112719','Videojuego de acción y disparos en primera persona desarrollado por id Software','21000',14,4),
(10,'Bloodborne','102751','Videojuego de acción y aventuras desarrollado por From Software','14500',12,4),
--Juegos de mesa
(11,'Torre De Equilibrio Jenga En Madera','349404','Pon a prueba tu agilidad, destreza y nervios y desafía a todos tus amigos y familiares y pasa horas de diversión con el Set De Torre de Equilibrio, cambia de posición las fichas, pero ten cuidado no se vaya a caer la torre, el primero en dejar caer todas las piezas perderá, ¿Quién dejará caer La Torre? ¿Serás tú? El estuche ofrece una solución de almacenamiento conveniente cuando termina el tiempo de juego. Desafía a todos, ideal para jugar mínimo entre 2 personas. Set incluye 48 piezas de madera en una lata para conservarlas una vez terminado la emoción. Edad recomendada 8 años.','7990',1,2),
...
(15,'Juego Super Banco Costa Rica','012597','Pasar más tiempo en familia, compartiendo estos juegos de mesa y dejando al lado la tecnología.','8890',4,2),
...
(21,'Rompecabezas Jumbo Mapamundi','306058','Aprender la ubicación, formas y los nombres de todos los continentes y grandes océanos 33 piezas resistentes, extragruesas (cartón) Superficie de fácil cuidado 24" L x 36" W montado. 6 + años.','7495',6,2),
...
(32,'Utensilios de Cocina Chef´s Colección','983219','Set de Utensilios de Cocina Chef´s Colección','14495',8,1),
--Juegos de Música
...
(44,'Palos de Golf','658412','Palos, y bolas de golf plásticas, perfectas para niños','7500',24,5),
...
(49,'Tablero de dardos','854969','Tablero de plástico para practicar tiro al blanco','7000',29,5),
(50,'Dardos','745745','Dardos, paquete de 6','5000',30,5),
(51,'Sports Center','556662','Centro de deportes para niños de 1 a 2 años','15000',31,5),
