...
--Juegos de mesa
(11,'Torre De Equilibrio Jenga En Madera','349404','Pon a pueda tu agilidad, destreza y nervios y desafÃ­a a todos tus amigos y familiares y pasa horas de diversiÃ³n con el Set De Torre de Equilibrio, cambia de posiciÃ³n las fichas pero ten cuidado no se vaya a caer la torre, el primero en dejar caer todas las piezas perderÃ¡, Â¿QuiÃ©n dejara caer La Torre? Â¿SerÃ¡s tÃº? El estuche ofrece una soluciÃ³n de almacenamiento conveniente cuando termina el tiempo de juego. DesafÃ­a a todos, ideal para jugar mÃ­nimo entre 2 personas. Set incluye 48 piezas de madera en una lata para conservarlas una vez terminado la emociÃ³n. Edad recomendada 8 aÃ±os.','7990',1,2),
(12,'Monopoly Classic','739792','La emociÃ³n de llevar a la bancarrota a un oponente, pero vale la pena jugar bien, porque la suerte podrÃ­a cambiar con el lanzamiento de los dados. Â¡Experimente los altibajos recogiendo conjuntos de colores de propiedad para construir casas, y tal vez incluso actualizÃ¡ndose a un hotel! Cuantas mÃ¡s propiedades posea cada jugador, mÃ¡s alquiler se puede cobrar. Las cartas de oportunidad podrÃ­an valer dinero, o uno podrÃ­a decir Â¡Ir a la cÃ¡rcel! Los nombres y logotipos de Hasbro Gaming y Monopoly, el diseÃ±o distintivo del tablero de juego, los cuatro cuadrados de las esquinas, el nombre y el personaje de Mr. Monopoly, asÃ­ como cada uno de los elementos distintivos del tablero y las piezas de juego son marcas registradas de Hasbro. -8 jugadores.','15995',2,2),
...
(14,'Damas Clasico','012038','El juego de las damas uno de los juegos de mesa mÃ¡s clÃ¡sicos y apasionantes que podemos disfrutar.','3795',4,2),
...
(51,'Sports Center','556662','Centreo de deportes para niÃ±os de 1 a 2 aÃ±os','15000','31','5'),
(52,'Mini Cancha de futbol','858202','Cancha de futbol con bola para niÃ±os de 2 a 3 aÃ±os','17500','32','5'),
